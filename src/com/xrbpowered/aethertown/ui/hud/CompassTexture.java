...
public class CompassTexture {
	...
	public static Texture create() {
		BufferTexture texture = new BufferTexture(radius*2, radius*2, false, false, true);
		GraphAssist g = new GraphAssist(texture.startUpdate());
		...
		g.graph.clearRect(0, 0, texture.getWidth(), texture.getHeight());
