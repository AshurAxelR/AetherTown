...
public class StarData {
	...
	public static ArrayList<String> getStarInfo(ArrayList<Star> chartStars) {
		ArrayList<String> out = new ArrayList<>();
		for(Star s : chartStars) {
			String tier;
			if(s.mag<-3.6f)
				tier = "Mythical";
			else if(s.mag<-2.6f)
